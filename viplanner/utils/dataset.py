...
class PlannerDataGenerator(Dataset):
    ...
    def __init__(
        ...
        generated_dir_token = f"pid_{os.getpid()}_{id(self):x}"
        self.img_warp_dir = os.path.join(self.root, "img_warp", generated_dir_token)
        self.depth_noise_edge_dir = os.path.join(self.root, "depth_noise_edges", generated_dir_token)
    ...
    def get_pairs(self):
        ...
        if self.semantics or self.rgb:
            ...
            # make dir
            os.makedirs(self.img_warp_dir, exist_ok=True)
    ...
    def _get_overlay_img(self, odom_idx):
        ...
        os.makedirs(self.img_warp_dir, exist_ok=True)
        sem_rgb_image_path = os.path.join(self.img_warp_dir, sem_rgb_filename)
    ...
    def noise_edges(self):
        ...
        depth_noise_edge_dir = self.depth_noise_edge_dir
    ...
    def _cleanup_generated_dir(self, path: str):
    ...
    def cleanup(self):
        ...
        self._cleanup_generated_dir(self.img_warp_dir)
        # remove depth_noise_edges directory
        self._cleanup_generated_dir(self.depth_noise_edge_dir)
        print("Done!")
        return
